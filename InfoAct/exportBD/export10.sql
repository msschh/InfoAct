--------------------------------------------------------
--  File created - duminică-mai-06-2018   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_ROL_DREPT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into FAVORIT (ID,ID_FILM,ID_USER) values ('14','21','1000');
...
SET DEFINE OFF;
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('12','1','1');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('13','1','2');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('23','2','5');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('10','1','3');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('21','2','7');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('11','1','4');
Insert into ROL_DREPT (ID,ID_ROL,ID_DREPT) values ('22','2','6');
...
--------------------------------------------------------
  ...
  ALTER TABLE "ROL_DREPT" ADD CONSTRAINT "ROL_DREPT_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "ROL_DREPT" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ACTOR
--------------------------------------------------------

  ALTER TABLE "ACTOR" ADD CONSTRAINT "ACTORI_PK" PRIMARY KEY ("ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "UTILIZATOR_ROL" ADD CONSTRAINT "UTILIZATOR_ROL_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "UTILIZATOR_ROL" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ROL
--------------------------------------------------------

  ALTER TABLE "ROL" ADD CONSTRAINT "ROL_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "ROL" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table FAVORIT
--------------------------------------------------------

  ALTER TABLE "FAVORIT" ADD CONSTRAINT "FAVORITE_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "FAVORIT" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ATASAMENT
--------------------------------------------------------

  ALTER TABLE "ATASAMENT" ADD CONSTRAINT "ATASAMENT_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "ATASAMENT" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DREPT
--------------------------------------------------------

  ALTER TABLE "DREPT" ADD CONSTRAINT "DREPT_PK" PRIMARY KEY ("ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "ACTOR_FILM" ADD CONSTRAINT "ACTOR_FILM_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "ACTOR_FILM" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table FILM
--------------------------------------------------------

  ALTER TABLE "FILM" ADD CONSTRAINT "FILM_PK" PRIMARY KEY ("ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "DOCUMENT" ADD CONSTRAINT "DOCUMENT_PK" PRIMARY KEY ("ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "UTILIZATOR" ADD CONSTRAINT "TABLE1_PK" PRIMARY KEY ("ID") ENABLE;
